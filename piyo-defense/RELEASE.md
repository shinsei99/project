...
> # ⛔ このアプリは **単体では App Store に出さない**（2026-08-30 オーナー指示）
>
> **ひよこ防衛軍は「ネオンブロックス」の中に7本入りの1本として入る。**
> `neon-blocks/www/games/piyo/` がその実体で、出口は**ネオンブロックスの更新**。
> このファイルに書いてある「単体で出す手順」は**いま使わない**。
> アプリの本数を増やすと 4.3(a)（スパム）の指摘に逆戻りするため。
>
> 再開の順番（直下 `TODO.md`）: ① スクラップメモ 1.0.5 → ② KeyTag 再申請 →
> ③ **ネオンブロックスの更新（7本入り）** ← ここでひよこ防衛軍が世に出る
>
> ---
>
> ## 経緯: 2026-08-29 の 4.3(a) 一斉リジェクト
>
