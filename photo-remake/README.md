...
- **図形**：四角 / 角丸 / 丸 / 三角 / ひし形 / 五角形 / 六角形 / 星 / ハート / 吹き出し / 十字 / バツ の12種。**塗りの色と枠線の色を別々に指定でき、それぞれ「なし」にできる**（塗りなし＝枠線だけ／枠線なし＝塗りだけ。両方なしにはならない）。線の太さ・塗りの透け具合も調整可。本体ドラッグ=移動、右下ハンドル=大きさ、右上ハンドル=回転
