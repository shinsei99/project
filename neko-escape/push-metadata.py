#!/usr/bin/env python3
"""`store-text.md` の内容を App Store Connect へ流し込む（にゃんこ大脱出）。
...
SUPPORT_URL = "https://shinsei99.github.io/project/neko-escape/support.html"
PRIVACY_URL = "https://shinsei99.github.io/project/neko-escape/privacy.html"
COPYRIGHT = "2026 SHINSEI PROPERTY MANAGEMENT.K.K."
PRIMARY_CATEGORY = "GAMES"
PRIMARY_SUBCATEGORY = "GAMES_PUZZLE"   # ★このアプリはパズル（考える遊び。アクションではない）
