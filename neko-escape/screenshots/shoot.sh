...
#
# 使い方:
#   ./screenshots/shoot.sh title board gimmick door clear select   # iPhone
#   DEVICE=ipad ./screenshots/shoot.sh title board gimmick door clear select
set -euo pipefail
cd /Users/apple/neko-escape
...
BUNDLE=com.daikyo.nekoescape
PUB=ios/App/App/public/index.html

mkdir -p "$OUT"
xcrun simctl boot "$UDID" 2>/dev/null || true
# ★ステータスバーを整える。放っておくと「◀ 前のアプリ名」や実時刻が写り込む
