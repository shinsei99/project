...
> ### D. 余力があれば
>
> - **小説の続編『不動産屋、つくってます。』は 2026-08-22 に脱稿している**（全32話・95,119字）。
>   **カクヨムには未投稿で、作品ページもまだ作っていない**。原稿は GoogleDrive
>   『新誠プロパティ/新誠不動産/続編_カクヨム用/』（**git管理外**なので両PCとも Drive から読む）。
>   次は 通し推敲 → 作品ページ作成 → 投稿（**直近24時間の投稿数に非公開の上限**があるので
