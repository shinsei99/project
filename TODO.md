...
>
> - **App Store の審査結果を3本確認**: デジタル書斎（1.0.0/build1・8/19提出）／
>   スクラップメモ（1.0.4/build8・8/19提出）／KeyTag（1.0.0/build2・8/18提出）。
...
> - **業務日報を一度手で回す**。サブPCのDBは tasks が3件しか無く、日報の
>   「本日動いたTODO／未完了TODO」欄だけ実測できていない。初回の本番投稿は人が見ている時間に
>
> ### D. 余力があれば
>
