...
>   未公開の終章と続編側だけを直した。
>   **①谷中**: 前編終章では「開業直後に谷中から電話が来て、ワンルームと戸建てを引き取り、門扉の板きれを
>   付け替える」だったが、続編は「谷中の九戸は42戸の一部で、3年目に久美が訪ねて一度断られる」構造。
>   → 前編終章を**久美が断る**場面に書き替え（「ほな、できるようになってから、来い」で終わる）、
>   受託・板きれの付け替えは**続編22話へ移設**。続編21話に「九戸のうち七戸を返し、二戸は誠一の一存で
>   残された」「開業した年の暮れに電話があり、断った。そのあと谷中は残る二戸も引き上げた」を追記。
>   これで**前編16話（公開済み）の「谷中の二部屋だけは残された」がそのまま生きる**。
>   **②老女の売却**: 前編終章の「新会社の、**初めての**売却」を外した（続編13話＝村瀬の査定が初回のため）。
>   **③年表**: 開業2025／前編終章のラスト2027秋（＝続編26話と同時期）／続編終章2029。
>   **前編終章は続編の「4年後のあと」ではなく2年目と同時期**なので、老女の売却は「何年か経った頃」に置いた。
