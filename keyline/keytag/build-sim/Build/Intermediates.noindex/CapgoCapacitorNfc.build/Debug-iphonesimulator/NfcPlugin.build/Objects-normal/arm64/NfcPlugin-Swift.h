...
#ifndef NFCPLUGIN_SWIFT_H
#define NFCPLUGIN_SWIFT_H
...
SWIFT_CLASS_NAMED("NfcPlugin")
@interface NfcPlugin : CAPPlugin <CAPBridgedPlugin>
...
- (void)startScanning:(CAPPluginCall * _Nonnull)call;
- (void)stopScanning:(CAPPluginCall * _Nonnull)call;
- (void)write:(CAPPluginCall * _Nonnull)call;
- (void)erase:(CAPPluginCall * _Nonnull)call;
- (void)makeReadOnly:(CAPPluginCall * _Nonnull)call;
- (void)share:(CAPPluginCall * _Nonnull)call;
- (void)unshare:(CAPPluginCall * _Nonnull)call;
- (void)getStatus:(CAPPluginCall * _Nonnull)call;
- (void)showSettings:(CAPPluginCall * _Nonnull)call;
- (void)getPluginVersion:(CAPPluginCall * _Nonnull)call;
- (void)isSupported:(CAPPluginCall * _Nonnull)call;
...
@interface NfcPlugin (SWIFT_EXTENSION(NfcPlugin)) <NFCNDEFReaderSessionDelegate>
