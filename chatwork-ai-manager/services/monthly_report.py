...
日報（社員ごと・毎日・実務の記録）とは役割も起点も別物:
  ...
  - 内容: 月次会議（社長挨拶→各担当の業務報告→今後の改善点・現状の問題点の3部構成）の記録。
    社長挨拶は月報に含めず、**各担当の業務報告**（鷲見・塚本・松本・森・吉浦・大鹿の順、
    欠席者は省略）と**今後の改善点・現状の問題点**の2セクションで出力する（TASK-20260825-003）。
...
2. 各担当の業務報告（鷲見・塚本・松本・森・吉浦・大鹿の順。欠席者は報告なし）
3. 今後の改善点や現状の問題点
...
この下に、会議資料の中で実際に業務報告がある担当だけ、**鷲見・塚本・松本・森・吉浦・大鹿の順**で
小見出し（###・担当者名のみ）を作り、その人の報告内容を箇条書きでまとめる。
