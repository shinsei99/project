...
from views import (  # noqa: E402
    ai_confirm, analysis_log, daily_report, dashboard, dev_tasks, knowledge, monthly_report, outbox,
...
_RENDER = {
    ...
    "daily_report": daily_report.render, "monthly_report": monthly_report.render,
