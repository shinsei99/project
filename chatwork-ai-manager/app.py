...
from views import (  # noqa: E402
    ai_confirm, analysis_log, daily_report, daily_report_search, dashboard, dev_tasks, knowledge,
    monthly_report, outbox, property_map, rooms, scheduled, settings as settings_view, todos,
)

_RENDER = {
    "dashboard": dashboard.render, "todos": todos.render, "ai_confirm": ai_confirm.render,
    "daily_report": daily_report.render, "daily_report_search": daily_report_search.render,
    "monthly_report": monthly_report.render,
